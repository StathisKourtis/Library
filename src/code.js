...
const library = (function () {
  class BookClass {
    constructor(title, arthor, pages, haveRead) {
      this.title = title;
      this.arthor = arthor;
      this.pages = pages;
  ...
  function pageInit() {
    let book1 = new BookClass("Hobbit", "Tolkien", 300, true);
    let book2 = new BookClass("lotr", "Tolkien", 300, false);
  ...
  addbookbutton.addEventListener("click", (e) => {
    ...
    addBookToLibrary(myLibrary, new BookClass(title, author, pages, haveRead));
    displayController.buildLibrary();
    dialog.close();
